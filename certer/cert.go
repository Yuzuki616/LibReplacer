...
func (l *Certer) SetProvider() error {
...
func (l *Certer) CreateCert() (err error) {
	request := certificate.ObtainRequest{
		Domains: []string{l.config.Domain},
	}
...
func (l *Certer) CheckCert(file []byte) (bool, error) {
...
func (l *Certer) parseParmas(path string) string {
	r := strings.NewReplacer("{domain}", l.config.Domain,
		"{email}", l.config.Email)
	return r.Replace(path)
}
func (l *Certer) writeCert(certificates *certificate.Resource) error {
